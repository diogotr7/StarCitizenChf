...
public static class Download
{
    ...
    public static async Task DownloadAllMetadata(string folder)
    {
        ...
        await File.WriteAllTextAsync(Path.Combine(folder, "total.json"), JsonSerializer.Serialize(rowsList));
    }
